...
//Questions and Options array (the actual quiz)
const quizArray = [
  {
    id: "0",
  ...
  },
  {
    ...
    options: ["To stop the function's execution", "To return a value from the function", "To print a message to the console", "To declare a new variable"],
    correct: "To return a value from the function"
  },
  {
    id: "2",
    question: "How can you convert a string to an integer in JavaScript?",
    options: ["parseInt()", "toInt()", "convertToInt()", "strToNum()"],
    correct: "parseInt()"
  },
];
